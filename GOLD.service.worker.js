...
/** @type {string} */
const CACHE_VERSION = '1751635576|15601511839';
/** @type {string} */
const CACHE_PREFIX = 'GOLD-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'GOLD.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["GOLD.html","GOLD.js","GOLD.offline.html","GOLD.icon.png","GOLD.apple-touch-icon.png","GOLD.audio.worklet.js","GOLD.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["GOLD.wasm","GOLD.pck"];
